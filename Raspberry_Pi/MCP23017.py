...
class MCP23017:
	...
	def write_all_pin(self, pinA,pinB):
		...
		self.bus.write_byte_data(self.address, 0x09, pin)
	...
	def __setup(self):
		...
		self.bus.write_byte_data(self.address, 0x09, 0x00) # set to 0 (LOW) all output
		self.bus.write_byte_data(self.address, 0x0A, 0x00) # set to 0 (LOW) all output latches
		...
		self.bus.write_byte_data(self.address, 0x19, 0x00) # set to 0 (LOW) all output
		self.bus.write_byte_data(self.address, 0x1A, 0x00) # set to 0 (LOW) all output latches
